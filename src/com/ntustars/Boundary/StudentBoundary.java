...
//        System.out.println("|5. Change Index Number of Course                    |");
    ...
    private String getCourseIDAdd() throws IOException {
        String courseIDStr;
...
//        this.courseID = courseID;
    ...
    private String getCourseIndexAdd(String courseID) throws IOException {
        String courseIndex;
...
//            if (studentManager.isCourseIDCollision(userName,courseIndex)) {
...
//        this.courseIndex = courseIndex;
    ...
    private String getCourseIndexRemove(String userName) throws IOException {
...
//        this.courseID = courseID;
    ...
    private String getUser2() throws IOException {
        String userName;
        do {
    ...
    private void updateCourseIndexInfoAdd (String userName, String courseIndex) throws IOException {
        ...
        do {
            ...
            switch (this.select) {
                case 1:
                    ...
                    String courseIndex42 = getCourseIndexAdd(courseID);

                    Student student = studentManager.updateSingleStudent(userName, courseIndex42, "ADD");
                    studentManager.updateStudentInfoDB(student);
                    CourseIndex courseIndex11 = courseManager.readCourseIndexbyID(courseIndex42);
                    courseIndex11.addStudent(student.getUsername());
                    courseIndex11.setSlot(courseIndex11.getSlot() - 1);
                    courseManager.updateCourseIndexInfoCompoDB(courseIndex11);
                    studentManager.addCourse(this.userName);
